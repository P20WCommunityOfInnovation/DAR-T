...
from constants import NONE_RANGE_COL_ONE_TEXT, NONE_RANGE_COL_TWO_TEXT, NONE_RANGE_COL_THREE_TEXT, RANGE_COL_ONE_TEXT, RANGE_COL_TWO_TEXT, RANGE_COL_THREE_TEXT
...
if uploadedFile:
    ...
    if st.session_state[ACTIVE_RANGE_SESSION_KEY] == SELECT_NON_RANGE:
        col_value = [NONE_RANGE_COL_ONE_TEXT,NONE_RANGE_COL_TWO_TEXT,NONE_RANGE_COL_THREE_TEXT]
